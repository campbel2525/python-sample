...
#         max_tokens: int = 1000,
#     ) -> str:
#         if max_tokens not in config.openai.USEABLE_MODEL_NAME:
...
#         encode_name = config.openai.ENCODE_NAME[model_name]
...
#         return config.openai.MAX_TOKEN[model_name] > total_tokens
