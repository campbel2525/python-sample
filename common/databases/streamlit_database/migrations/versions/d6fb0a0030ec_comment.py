...
Revision ID: d6fb0a0030ec
Revises:
Create Date: 2024-02-09 13:56:34.108914
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "category", sa.String(length=255), nullable=False, comment="カテゴリ"
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "chapter_title", sa.String(length=255), nullable=True, comment="章名"
        ),
        sa.Column("content", mysql.LONGTEXT(), nullable=False, comment="内容"),
        sa.Column(
            "file_name", sa.String(length=255), nullable=False, comment="ファイル名"
        ),
        sa.Column(
            "file_type", sa.String(length=255), nullable=False, comment="ファイルタイプ"
        ),
